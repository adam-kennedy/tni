...
function calculate_tni(&$serverVars, $params_output, $params_stdBegin, $params_stdEnd, &$periods, $verbose='')
{
   ...
   //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ End: initialize...
	...
	$data =  get_tni_data($serverVars, $params_output); //get the data 
   //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Begin: calculations...
	for ($i=1; $i<count($data); ++$i) //use all the data
	...
	unset($data[count($data)]); //don't delete the last dataLine, since it is empty...
